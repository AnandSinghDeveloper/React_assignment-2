...
const Section1 = () => {
  return (
    <div className='w-full h-140 bg-gray-100 mt-20 p-10 flex justify-center items-center gap-20'>
      ...
      <div className='w-120 h-120 bg-white p-10  ' >
      ...
      <button className=' px-5 bg-[#ADB52E] py-2 font-normal text-white text-base shadow-md mt-10 w-38 '> VIEW PRICEING</button>
      </div>
